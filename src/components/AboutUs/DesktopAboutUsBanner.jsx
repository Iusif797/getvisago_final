  ...
  return (
    <section className="w-full py-16 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 lg:px-8 flex flex-col items-center justify-center text-center">
        ...
        <button className="bg-white text-purple-600 font-medium py-3 px-8 rounded-full hover:shadow-xl transform transition-all duration-300 hover:scale-105 mx-auto">
          READ MORE ABOUT US
        </button>
      </div>
    </section>
