  ...
  return (
    <section className="w-full py-12 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 flex flex-col items-center justify-center text-center">
        ...
        <Link to="/about" className="bg-white text-purple-600 font-medium py-3 px-6 rounded-full hover:shadow-xl transform transition-all duration-300 hover:scale-105 text-sm">
          УЗНАТЬ БОЛЬШЕ О НАС
        </Link>
      </div>
    </section>
