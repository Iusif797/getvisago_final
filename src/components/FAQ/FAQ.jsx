...
const FAQ = () => {
  ...
  const faqItems = [
    {
      question: "Как происходит процесс покупки визы на вашем сайте",
