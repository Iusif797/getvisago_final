                            ...
                            <div className="flex justify-between items-center mb-3">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-4 font-bold text-gray-800 flex items-center text-lg">
                                        <img src={australiaFlag} alt="AU" className="w-7 h-5 mr-3 object-cover rounded shadow-sm" />
                                        {visa.label}
                                    </span>
                                </div>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div>
                                <label className="text-base font-medium text-gray-700 mb-2 block">City *</label>
                                <input type="text" name="australiaCity" placeholder="Enter name" className="w-full p-4 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 shadow-sm" />
                            </div>
                            <div>
                                <label className="text-base font-medium text-gray-700 mb-2 block">Street =</label>
                                <input type="text" name="australiaStreet" placeholder="Enter name" className="w-full p-4 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 shadow-sm" />
                            </div>
                            <div>
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-2xl shadow-sm space-y-5 mb-8">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <span className="text-base text-gray-700">ETA (Electronic Travel Authority)</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-medium text-purple-600">1 year</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-medium text-purple-600">Multiple entries</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-medium text-purple-600">up to 90 days per visit</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-medium text-purple-600">3-7 days</span>
                    </div>
                </div>
