                            ...
                            <div className="flex justify-between items-center mb-2">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-3 font-bold text-gray-800 flex items-center">
                                        <img src={cambodiaFlag} alt="KH" className="w-6 h-4 mr-2 object-cover rounded" />
                                        {visa.label}
                                    </span>
                                </div>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="text-sm font-medium text-gray-700 mb-1 block">City *</label>
                                <input type="text" name="cambodiaCity" placeholder="Enter name" className="w-full p-3 bg-white border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 transition" />
                            </div>
                            <div>
                                <label className="text-sm font-medium text-gray-700 mb-1 block">Street =</label>
                                <input type="text" name="cambodiaStreet" placeholder="Enter name" className="w-full p-3 bg-white border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 transition" />
                            </div>
                            <div>
                    ...
                    <div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center">
                                    <span className="text-sm font-medium text-purple-600 mr-2">Салманова Ватанияна</span>
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center">
                                    <span className="text-sm font-medium text-purple-600 mr-2">Россия</span>
                                    <FaEdit className="text-purple-600 cursor-pointer" />
                                </div>
                            </div>
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center">
                                    <span className="text-sm font-medium text-purple-600 mr-2">485710493</span>
                                    <FaEdit className="text-purple-600 cursor-pointer" />
                                </div>
                            </div>
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center">
                                    <span className="text-sm font-medium text-purple-600 mr-2">05.05.2015</span>
                                    <FaEdit className="text-purple-600 cursor-pointer" />
                                </div>
                            </div>
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center">
                                    <span className="text-sm font-medium text-purple-600 mr-2">05.05.2025</span>
                                    <FaEdit className="text-purple-600 cursor-pointer" />
                                </div>
                            </div>
                            <div className="flex justify-between items-center">
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-4 mb-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            ...
                            <span className="text-sm text-gray-700">Tourist visa B2</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium text-purple-600">2 years</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <FaClock className="text-purple-600 mr-2" />
                            <span className="text-sm text-gray-700">Travel within months</span>
                        </div>
                        <span className="text-sm font-medium text-purple-600">2 days</span>
                    </div>
                </div>
