  ...
  const slides = [
    {
      id: 1,
      image: bannerSA1,
      title: "Discover the Land of Fire, where ancient history meets modern architecture.",
      date: "31 May, 2025"
    },
    {
      id: 2,
      image: bannerSA2,
      title: "From the Caspian Sea to the Caucasus Mountains, Azerbaijan is a land of contrasts.",
      date: "31 May, 2025"
    }
  ];
      ...
      <div className="relative">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 -mt-32 sm:-mt-40">
          <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-md mx-auto flex flex-col">
            ...
            <Link
              to="/visa-application/azerbaijan"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {visaTypes.map((visa, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <Link to={`/visa-application/azerbaijan?type=${encodeURIComponent(visa.title)}`} className="block w-full mt-6 bg-white border-2 border-purple-600 text-purple-600 py-3 rounded-full font-bold text-center text-lg hover:bg-purple-50 transition-all duration-300">
                  APPLY NOW
                </Link>
              </div>
            ))}
