...
const BahrainVisa = () => {
  ...
  const desktopVisaData = {
    countryName: "Bahrein",
    bannerImage: bahrainImage,
    cost: "From 4700,80 ₹",
    approvalTime: "3-7 days",
    validity: "from 90 days",
    getVisaLink: "/get-visa/bahrain",
    ...
    visaTypes: [
      { title: 'Tourist single visa', icon: touristIcon, applyLink: "/get-visa/bahrain?type=Tourist+single+visa", details: [{ label: 'Validity', value: '60 days' }, { label: 'Stay per visit', value: '14 days' }, { label: 'Government fee', value: '2400,75 ₹' }, { label: 'Service fee', value: '2590' }] },
      { title: 'Tourist multiple visa', icon: touristIcon, applyLink: "/get-visa/bahrain?type=Tourist+multiple+visa", details: [{ label: 'Validity', value: '90 days' }, { label: 'Stay per visit', value: '30 days' }, { label: 'Government fee', value: '3698' }, { label: 'Service fee', value: '2790 ₹' }] },
      { title: 'Tourist multiple visa', icon: touristIcon, applyLink: "/get-visa/bahrain?type=Tourist+multiple+visa", details: [{ label: 'Validity', value: '1 year' }, { label: 'Stay per visit', value: '90 days' }, { label: 'Government fee', value: '10123,1 ₹' }, { label: 'Service fee', value: '2790 ₹' }] },
      { title: 'Tourist business visa', icon: touristIcon, applyLink: "/get-visa/bahrain?type=Tourist+business+visa", details: [{ label: 'Validity', value: '90 days' }, { label: 'Stay per visit', value: '30 days' }, { label: 'Government fee', value: '8900 ₹' }, { label: 'Service fee', value: '3090 ₹' }] },
      { title: 'Tourist multiple visa', icon: touristIcon, applyLink: "/get-visa/bahrain?type=Tourist+multiple+visa", details: [{ label: 'Validity', value: '5 year' }, { label: 'Stay per visit', value: '90 days' }, { label: 'Government fee', value: '16052 ₹' }, { label: 'Service fee', value: '2790 ₹' }] },
    ]
  };

  const [currentSlide, setCurrentSlide] = useState(0);
  const slides = [
    { id: 1, image: bannerSA1, title: "Discover the Kingdom of Bahrain, an archipelago of history and modernity.", date: "27 May, 2025" },
    { id: 2, image: bannerSA2, title: "From ancient forts to a vibrant culinary scene, Bahrain awaits.", date: "27 May, 2025" }
  ];
  ...
  const visaTypes = [
    { title: 'Tourist single visa', validity: '60 days', stay: '14 days', govFee: '2400,75 ₹', serviceFee: '2590' },
    { title: 'Tourist multiple visa', validity: '90 days', stay: '30 days', govFee: '3698', serviceFee: '2790 ₹' },
    { title: 'Tourist multiple visa', validity: '1 year', stay: '90 days', govFee: '10123,1 ₹', serviceFee: '2790 ₹' },
    { title: 'Tourist business visa', validity: '90 days', stay: '30 days', govFee: '8900 ₹', serviceFee: '3090 ₹' },
    { title: 'Tourist multiple visa', validity: '5 year', stay: '90 days', govFee: '16052 ₹', serviceFee: '2790 ₹' }
  ];
