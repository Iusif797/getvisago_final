...
import cambodiaImage from '../assets/CambodiaS.JPG'; // Изображение Камбоджи
  ...
  const slides = [
    {
      id: 1,
      image: bannerSA1,
      title: "Explore the ancient wonders and vibrant culture of Cambodia.",
      date: "28 May, 2025"
    },
    {
      id: 2,
      image: bannerSA2,
      title: "From Angkor Wat to bustling markets, Cambodia offers a unique adventure.",
      date: "28 May, 2025"
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
            {visaTypes.map((visa, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6 max-w-sm mx-auto">
                ...
                <Link to={`/visa-application/cambodia?type=${encodeURIComponent(visa.title)}`} className="block w-full mt-6 bg-white border-2 border-purple-600 text-purple-600 py-3 rounded-full font-bold text-center text-lg hover:bg-purple-50 transition-all duration-300">
                  APPLY NOW
                </Link>
              </div>
            ))}
