  ...
  const slides = [
    {
      id: 1,
      image: bannerSA1,
      title: "Experience the vibrant culture and technological wonders of South Korea.",
      date: "01 June, 2025"
    },
    {
      id: 2,
      image: bannerSA2,
      title: "From the bustling streets of Seoul to the serene temples, South Korea has it all.",
      date: "01 June, 2025"
    }
  ];
      ...
      <div className="relative">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 -mt-32 sm:-mt-40">
          <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-md mx-auto flex flex-col">
            ...
            <Link
              to="/visa-application/south-korea"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {visaTypes.map((visa, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <Link to={`/visa-application/south-korea?type=${encodeURIComponent(visa.title)}`} className="block w-full mt-6 bg-white border-2 border-purple-600 text-purple-600 py-3 rounded-full font-bold text-center text-lg hover:bg-purple-50 transition-all duration-300">
                  APPLY NOW
                </Link>
              </div>
            ))}
