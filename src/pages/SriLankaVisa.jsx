...
const SriLankaVisa = () => {
  ...
  const desktopVisaData = {
    countryName: "Sri Lanka (ETA)",
    bannerImage: sriLankaImage,
    cost: "From 1 ₹",
    approvalTime: "1-2 days",
    validity: "180 days after issued",
    getVisaLink: "/get-visa/sri-lanka",
  ...
  const slides = [
    { id: 1, image: bannerSA1, title: "Discover the pearl of the Indian Ocean, Sri Lanka.", date: "27 May, 2025" },
    { id: 2, image: bannerSA2, title: "Ancient temples, lush tea plantations, and golden beaches await.", date: "27 May, 2025" }
  ];
